...
// function calculateDiscountedPrice(price, discountStr) {
...
//   creators.forEach(creator => {
//     const discountedPrice = calculateDiscountedPrice(creator.price, creator.discount);
//     const originalPrice = creator.price;
...
//         <h3>${creator.name}</h3>
//         <p>Category: ${creator.category}</p>
//         <p>Example Product: ₹${discountedPrice} <span class="original">₹${originalPrice}</span> (${creator.discount} OFF)</p>
//       </div>
//     `;
//     creatorContainer.appendChild(card);
//   });
